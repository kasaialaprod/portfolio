...
<body>
    <header>
        <h2>Projets Angular</h2>
        <p>Voici tout les projets que j'ai eu l'occasion de réaliser en Angular dans le cadre de mon apprentissage ;).</p>
    </header>
    <main>
        <div class="cards-wrapper" id="cardsWrapper">

            <?php if (empty($projects)): ?>
                <p>Aucun projet Angular pour le moment.</p>
            <?php else: ?>
